...
GetUi = function()
    ...
    L_637["Logo Image"] = "";
    L_638["Logo Image"] = "";
    -- Refined default palette: near-black navy surfaces with softer blue accents.
    L_638["Background Main Color"] = Color3.fromRGB(12, 14, 22);
    L_638["Background 1 Color"] = Color3.fromRGB(22, 25, 36);
    L_638["Background 2 Color"] = Color3.fromRGB(34, 39, 54);
    L_638["Background 3 Color"] = Color3.fromRGB(18, 21, 31);
    L_638["Border Color"] = Color3.fromRGB(58, 63, 78);
    L_638["Title Text Color"] = Color3.fromRGB(132, 170, 255);
    local L_639 = {};
